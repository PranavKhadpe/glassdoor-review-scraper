...
def get_browser():
    ...
    # Insert path to chromedriver
    browser = wd.Chrome(executable_path="/Users/pkhadpe/Desktop/Glassdoor-data/glassdoor-review-scraper/chromedriver", options=chrome_options)
    return browser
